...
#' 
#' @description
#' This function plots a panel of two graphics for one counts series 
...
#'   (blue line) with the 95% CI. Dots (with intervals) represent converted 
#'   counts passed to the model;
#' - on the right side, a bar plot of estimated relative growth rates (r) by 
#'   year. Dark bars are estimated r.
#' 
#' @param series a character of length 1. The counts series names (can be 
#'   retrieved by running [list_series()]).
#'   
...
#'   on the top-right of the plot.
#'   
#' @param path a character. The directory in which counts series (and BUGS 
