...
#' Extract the count series corresponding to a location and/or a species in a list
#' 
#' @description
...
#'   to be imported. If `NULL` (default), all available count series will be 
#'   imported.
#'    
#' @param path a character string. The directory in which count series have been 
