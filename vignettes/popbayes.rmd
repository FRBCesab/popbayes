...
`species_info` table of the package (when the other two sources are missing). 
...
in addition to other species present in the package `species_info` table. 
...
species can attain in a year (or another time unit).
...
species) can be provided as an additional column of the count dataset (`garamba`),
as additional column of the `info` data frame, or internally can be retrieved 
...
`conversion_A2G = "column_with_conversion_A2Gor"`, `rmax = "rmax"`,
...
Bayesian framework where the primary quantity being modeled is the rate of 
increase between successive years (or any other time unit).
...
- Cornelis _et al._ (2014) ...
- Foley & Faust (2010) Rapid population growth in an elephant _Loxodonta africana_ 
...
- Illius & Gordon (1992) Modelling the nutritional ecology of ungulate 
herbivores: evolution of body size and competitive interactions. 
_Oecologia_, **89**, 428-434.
DOI: [10.1017/S0030605309990706](https://doi.org/10.1017/S0030605309990706).
- Kingdon & Hoffman (2013) ...
- Sinclair (1996) ...
