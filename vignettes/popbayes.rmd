...
![](docs/popbayes-diagram.png){width=100%}
...
a_buselaphus <- popbayes::filter_series(garamba_formatted, species = "Alcelaphus buselaphus")
```

```{r 'get-series-data-3'}
## Extract converted data for series with A. buselaphus ----
popbayes::series_to_df(a_buselaphus, converted = TRUE)
```
