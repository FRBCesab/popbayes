...
In addition to the fields `location`, `species`, `date`, and `counts`, a fourth 
...
The package `popbayes` provides the `species_info` data set, which contains
...
can attain in a year (or another time unit).
